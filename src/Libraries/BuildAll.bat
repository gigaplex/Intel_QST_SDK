...
rem                                                                       rem
rem   File Name:     Libraries\BuildAll.bat                               rem
rem                                                                       rem
rem   Description:   Builds DOS and Windows versions  of  the  Intel(R)   rem
rem                  Quiet  System Technology (QST) Instrumentation and   rem
rem                  Communications libraries.                            rem
rem                                                                       rem
rem remremremremremremremremremremremremremremremremremremremremremremrem rem
...
echo SDK Libraries Built Successfully!
goto DONE

:FAILED
echo SDK Libraries Build Failed!
